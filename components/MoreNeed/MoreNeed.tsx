...
const MoreNeed = () => {
  return (
    ...
    <h1 className='font-with tamanhoNeed ml-10'>More you need to see</h1>
    <div className='flex flex-col md:flex-row justify-center gap-9 md:gap-8 mt-6'>
